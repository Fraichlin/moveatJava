...
public class RotationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        RotateTransition fourthTransition = new RotateTransition(Duration.seconds(2), rect4);
        ...
        FadeTransition fade4 = new FadeTransition(Duration.seconds(2), menu4);
        //Setting properties to fade transitions
        FadeTransition[] fadeTransitions = {fade1, fade2, fade3,fade4};
        ...
        RotateTransition[] rotateTransitions = {firstTransition, secondTransition, thirdTransition,fourthTransition};
        ...
        fourthTransition.setOnFinished((event4) -> {
            fade4.play();
        });
